...
@section('content')
    <div class="container mx-auto mt-8 p-6 bg-white rounded-lg shadow-md max-w-lg">
        <div class="text-center mb-6">
            <h2 class="text-2xl font-semibold text-green-700">Добавление Издания</h2>
            <p class="text-gray-600">Введите информацию о новом издании в библиотеку</p>
        </div>

        <form action="{{ route('edition.store') }}" method="post" class="space-y-4">
            @csrf
            <!-- Название Издания -->
            <div class="mb-4">
                <label for="title" class="block text-sm font-medium text-gray-700 mb-1">Издание</label>
                <input
                    type="text"
                    id="title"
                    name="title"
